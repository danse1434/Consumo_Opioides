# EUM CONSUMO DE OPIOIDES EN COLOBIA 2012 - 2018
...
data_SISMED[,'Periodo de Precios'] = apply(data_SISMED[,'Periodo de Precios'], MARGIN = 1, FUN = function(x){str_sub(x, 0, 4)}) %>% as.double(.)
